...
evaluations_agr$recall <- as.numeric(evaluations_agr$recall)
evaluations_agr$precision <- as.numeric(evaluations_agr$precision)
#evaluations_agr$k_value <- as.factor(evaluations_agr$k_value/60)
